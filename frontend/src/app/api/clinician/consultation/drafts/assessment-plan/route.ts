...
export const POST = async (request: Request): Promise<Response> => {
    try {
        ...
        const response = await apiClient.post(API.CONSULTATION_GENERATE_ASSESSMENT_PLAN_ENDPOINT, { visitId: body.visitId }, { headers: { Authorization: `Bearer ${guardResult.accessToken}` } });
