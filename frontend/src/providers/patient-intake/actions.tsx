...
export const initializeSucceeded = createAction<IPatientIntakeStatePayload, ICheckInResponse>(PatientIntakeActionEnums.initializeSucceeded, (payload: ICheckInResponse) => ({
