...
public abstract class MedStreamWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MedStreamWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MedStreamWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MedStreamDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MedStreamDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MedStreamDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MedStreamDbContext, Task<T>> func)
    {
        T result;
